...
CCFLAGS = -g -MP -MMD -m68000 -O2 -nostdlib -Wextra -Wno-unused-function -Wno-volatile-register-var -fomit-frame-pointer -fno-tree-loop-distribution -flto -fwhole-program -fno-exceptions -ffunction-sections -fdata-sections
CPPFLAGS= $(CCFLAGS) -fno-rtti -fcoroutines -fno-use-cxa-atexit
ASFLAGS = -Wa,-g,--register-prefix-optional,-I$(SDKDIR),-D
LDFLAGS = -Wl,--emit-relocs,--gc-sections,-Ttext=0,-Map=$(OUT).map
VASMFLAGS = -m68000 -Felf -opt-fconst -showopt -nowarn=62 -dwarf=3 -quiet -x -I. -I$(SDKDIR)
...
$(OUT).elf: $(objects)
	...
	@m68k-amiga-elf-objdump --disassemble --no-show-raw-ins --source-comment=; --visualize-jumps -S $@ >$(OUT).s
